...
document.addEventListener('DOMContentLoaded', function () {
  ...
  /* ==========================================================================
     ...
     Replace the body of this handler with your real form service call.
     ========================================================================== */
  ...
  if (submitBtn) {
    submitBtn.addEventListener('click', function () {
      ...
      /*
       * TO CONNECT TO FORMSPREE — uncomment and replace YOUR_FORM_ID:
       *
       ...
       *     reason:  document.getElementById('contact-reason') ? document.getElementById('contact-reason').value : '',
